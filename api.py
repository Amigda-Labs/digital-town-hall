...
Phase 4: Clean api.py for ChatKit Integration — Clean: Remove duplicate endpoints before integrating chatkit session. Will not be using custom code from Phase 2 & Phase 3 anymore.
"""
